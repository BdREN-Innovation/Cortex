...
**Institution:** Chittagong University of Engineering and Technology, Chattogram, Bangladesh

**Key Highlights: **

- Graduated as the **top of the department**.

**Thesis Title:  **Assessment of Flash Flood Vulnerability and Its Drivers in a Coastal District of Bangladesh: An Integrated Approach for Enhancing Flood Resilience

**2. Degree:** Bachelor of Urban and Regional Planning

**Institution:** Chittagong University of Engineering and Technology (CUET)

**Key Highlights:**

- Graduated as the **top of the department and faculty**.
- Awarded the prestigious **University Grants Commission (UGC) Merit Scholarship** for exceptional academic standing.
- Awarded the prestigious university technical **Scholarship** for exceptional academic standing.
- Consistently maintained a record of academic excellence, placing first in the class.

**Thesis Title: **Investigating Tropical Cyclone Induced Multi-Hazard Risk in Coastal Region Bangladesh Using Fuzzy Analytic Hierarchy Process Model.

**3. Degree:** Higher Secondary Certificate (HSC)
...
**Key Highlights:**
  ...
  - Achieved a **perfect GPA of 5.00 out of 5.00**.
  - Received a scholarship for exceptional performance.
, SSC

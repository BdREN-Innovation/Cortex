...
`CUET_SCRAPER_SPEC_PART2.md`. Both are gitignored and kept locally, not in
the repository.
...
├── _files/           Zipped in engine/crawl-archives/cuet.zip (Git LFS).
├── _meta/            api_dump.json is in that zip too; the rest generated.
│
